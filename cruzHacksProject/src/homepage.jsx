...
function HomePage({userId, logout}) {
  ...
  useEffect(() => {
    axios
      .get(`${baseURL}/test12345`) //hardcoded change to  axios.get(`${baseURL}/#{userId}`)
      .then((response) => {
        ...
        <div className="rightBox">
          ...
          <div className="statGriddy">
            ...
            <div className="bottomRow">
              <div className="statGridItemVideo">
                {' '}
                {incidents.length > 0 && (
                  <MuxPlayer
              ...
              <div className="statGridItemUnique">
                {incidents.length > 0 && (
                  <div className="incidentDetails">
                    <p>
                      <strong>Type:</strong> {incidents[0].title}
                    </p>
                    <p>
                      <strong>Severity:</strong> {incidents[0].severity}
                    </p>
                    <p>
                      <strong>Details:</strong> {incidents[0].meta}
                    </p>
                  </div>
                )}
              </div>
